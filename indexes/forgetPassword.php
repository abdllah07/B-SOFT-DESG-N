...
<html lang="en">
    <head>
        ...
        .parent .change-password a:hover {
    ...
    <body>
        ...
        <section class="parent container">
            ...
            <div class="change-password">
                <form action="sendChangeCode.php" method="post">
                    ...
                    <a href="indexSignUp.php">Did you remember the password?</a>
